...
class DriverTests(unittest.TestCase):
    def _build_app(self):
        ...
        provider.connect()
        service = MockVeDbusService("com.victronenergy.generator.autoterm_air2d")
    ...
    def test_dummy_provider_updates_mock_dbus(self):
        ...
        self.assertEqual(service["/StatusCode"], 1)
    ...
    def test_startstop_callback_updates_state(self):
        ...
        self.assertNotEqual(service["/State"], 0)
        self.assertEqual(service["/Alarms/Communication"], 0)
        self.assertGreaterEqual(service["/StatusCodeMajor"], 2)

        service.set_value("/StartStop", 0)
        self.assertEqual(service["/State"], 4)
